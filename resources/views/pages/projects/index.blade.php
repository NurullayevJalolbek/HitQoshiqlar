    ...
    <div class="filter-card">
        <div class="row g-3 align-items-end">
            <div class="col-md-3">
                ...
                <input type="text" id="searchInput" class="form-control" placeholder="Loyiha nomi, ID...">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <label for="statusFilter">Holat</label>
            ...
            <div class="col-md-2">
                <label for="riskFilter">Xavf darajasi</label>
