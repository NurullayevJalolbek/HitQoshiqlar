        ...
        <div class="card metric-card border-start border-primary border-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">{{ __('admin.kpi.active_investors') }}</p>
                        <h4 class="mb-0 fw-bold" id="activeInvestors">{{ formatCurrency(945) }}</h4>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card metric-card border-start border-warning border-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">{{ __('admin.kpi.passive_investors') }}</p>
                        <h4 class="mb-0 fw-bold" id="passiveInvestors">{{ formatCurrency(280) }}</h4>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card metric-card border-start border-success border-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">{{ __('admin.kpi.total_dividends') }}</p>
                        <h4 class="mb-0 fw-bold" id="totalDividends">{{ formatCurrency(5400000) }} UZS</h4>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card metric-card border-start border-info border-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-muted mb-1 small">{{ __('admin.kpi.net_profit') }}</p>
                        <h4 class="mb-0 fw-bold" id="netProfit">{{ formatCurrency(12300000) }} UZS</h4>
                    </div>
