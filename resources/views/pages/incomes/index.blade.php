...
@push('customCss')
<style>
/* Make filter card match project info-card look/spacing */
.filter-card {
    background: #ffffff;
...
/* Retain the stats-card in case it's enabled; slightly adjusted to fit theme */
.stats-card {
...
/* Re-use badge look from project page but keep existing color tokens */
.badge-custom {
    display: inline-flex;
    align-items: center;
    gap: 6px;
...
.badge-category-land {
    background: rgba(5, 101, 70, 0.08);
    color: #065f46;
}

/* Holat badge'lari (to‘lov holati) */
...
/* Action button layout — match other index pages */
.action-buttons {
    display: flex;
    gap: 0.375rem;
...
/* Small responsive tweaks for filter form */
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-3 breadcrumb-block px-3 mt-3 mb-2"
    ...
    <div class="d-flex gap-2 align-items-center flex-wrap">
        ...
        <button class="btn btn-sm p-0 d-flex align-items-center justify-content-center border" type="button"
            data-bs-toggle="collapse" data-bs-target="#incomesFilterContent" aria-expanded="true"
            aria-controls="#incomesFilterContent" title="Filter">
            <i class="bi bi-sliders2" style="font-size: 1.1rem;"></i>
        </button>
    </div>
</div>
@endsection
        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                <label for="statusFilter"
                    class="form-label mb-2">{{ __('admin.payment_status') ?? 'To‘lov holati' }}</label>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <button class="btn btn-sm p-0" type="button" title="Ko'rish">
