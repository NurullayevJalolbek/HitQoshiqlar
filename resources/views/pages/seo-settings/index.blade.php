...
<div class="seo-container mt-3">
    ...
    <div class="seo-card">
        ...
        <h3 class="seo-card-title">Loyiha Sahifasi SEO Sozlamalari</h3>
    ...
    <div class="preview-box">
        ...
        <div class="search-result">
            ...
            <div class="search-description">
                Envast platformasi orqali ko'chmas mulk investitsiyalari, ulushli moliyalashtirish va daromad kuzatuvi imkoniyati.
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.meta-value').forEach(function(element) {
            element.addEventListener('click', function() {
                ...
                navigator.clipboard.writeText(text).then(function() {
                    ...
                    element.innerHTML = '<i class="fas fa-check" style="color: #10B981; margin-right: 8px;"></i>Nusxalandi!';
        ...
        document.querySelector('.save-button').addEventListener('click', function() {
            ...
            setTimeout(function() {
                button.innerHTML = '<i class="fas fa-check-circle"></i> Muvaffaqiyatli saqlandi!';
                button.style.background = 'linear-gradient(135deg, #10B981 0%, #059669 100%)';
                button.style.opacity = '1';

                setTimeout(function() {
                    button.innerHTML = originalHTML;
                    button.style.background = 'linear-gradient(135deg, #1F2937 0%, #374151 100%)';
