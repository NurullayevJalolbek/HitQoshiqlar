                ...
                <li class="nav-item dropdown ms-lg-3">
                    <a class="nav-link dropdown-toggle py-0 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="media d-flex align-items-center" style="height: 43.9px">
                            <img class="avatar rounded-circle " alt="Image placeholder " style="object-fit: cover; height:100%; width: auto; aspect-ratio: 1/1" src="https://media.istockphoto.com/id/526947869/vector/man-silhouette-profile-picture.jpg?s=612x612&w=0&k=20&c=5I7Vgx_U6UPJe9U2sA2_8JFF4grkP7bNmDnsLXTYlSc="}>
