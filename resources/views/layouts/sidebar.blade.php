<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse">
    ...
    <div class="sidebar-inner px-4 pt-3 d-flex flex-column" style="height: 100vh;">

        <!-- Logo -->
        <div id="sidebar-top" class="mb-3">
        ...
        <!-- Scrollable menu -->
        <div id="sidebar-menu-wrapper" class="flex-grow-1 overflow-auto">
        ...
        <!-- Sidebar close icon -->
        <figure id="sidebar-close-figure" class="sidebar-close-figure mt-auto">
