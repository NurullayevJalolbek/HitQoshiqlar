...
document.querySelectorAll('.toggle-ai-permission').forEach(checkbox => {
    checkbox.addEventListener('change', function(e) {
        ...
        const confirmText = isChecked ?
            'Ruxsat berish <img src="{{ asset('
        assets / img / icons / allow.svg ') }}" style="width: 16px;">':
            'Taqiqlash <img src="{{ asset('
        assets / img / icons / deny.svg ') }}" style="width: 16px;">';

        const cancelText =
            'Bekor qilish <img src="{{ asset('
        assets / img / icons / cancel - button.png ') }}" style="width: 16px;">';
...
document.querySelectorAll('.delete-chat').forEach(form => {
    form.addEventListener('submit', function(e) {
        ...
        Swal.fire({
            ...
            admin.Delete ') }} <img src="{{ asset('
            assets / img / icons / trash
            .png ') }}" style="width: 16;" class="fas fa-trash-alt"></img>',
            cancelButtonText: '{{ __('
            message.Cancel ') }} <img src="{{ asset('
            assets / img / icons / cancel - button
            .png ') }}" style="width: 16;" class="fas fa-times-circle"></img>',
            buttonsStyling: false,
            customClass: {
...
document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(trigger => {
    trigger.addEventListener('click', function(e) {
        if (sidebarMenu.classList.contains('contracted')) {
            e.preventDefault(); // Bootstrap collapse ni bloklaydi
        }
    });
});
</script>
